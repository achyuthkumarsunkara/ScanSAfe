    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 py-20">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          {/* Top Leaderboard Ad */}
          <div className="mb-8">
            <AdSenseAd slot="2345678901" format="leaderboard" className="mx-auto" />
          </div>
          ...
          {!isScanning && !scanResult && (
            <div className="my-8">
              <AdSenseAd slot="2345678902" format="rectangle" className="mx-auto" />
            </div>
          )}
          ...
          <div className="mt-12">
            <AdSenseAd slot="2345678903" format="horizontal" className="mx-auto" />
